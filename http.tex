...
\begin{tabular}{@{}lllll@{}}
\toprule
Method & Target & Action  & Parameters     & Example                                             \\ \midrule
...
\begin{tabular}{@{}lll@{}}
\toprule
Status Code              & Happens when                                                   & Response content                             \\ \midrule
\texttt{200 OK}          & On successful \texttt{GET} request                     & Resource content                    \\
\texttt{201 Created}     & On successful \texttt{POST} request                    & Output location                     \\
\texttt{302 Found}       & Redirect                                               & Redirect Location                   \\
\texttt{400 Bad Request} & R raised an error.                                     & Error message in \texttt{text/plain} \\
\texttt{502 Bad Gateway} & Cache connectivity failure.                            & -- (See error logs) \\
...
\begin{tabular}{@{}lllll@{}}
\toprule
 Format & \texttt{Content-type}             & Encoding function      & Example    \\ \midrule
