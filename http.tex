...
This section fills in the details of the \OpenCPU system. It is explained how the abstract concepts get shape in the context of \HTTP and how these were implemented using \R. 

This is the core of the system. Might get extended.
...
\subsubsection{Argument formats}
...
A \POST request targeting a file with a recognized file extension results in an execution of the script.  
...
\end{tabular}
\caption{Supported script types and the interpreting fucntion}
\label{table:scripts}
\end{table}
